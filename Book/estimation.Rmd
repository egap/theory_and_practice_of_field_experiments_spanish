...
- Un **efecto causal**, $\tau_i$, es una comparación de las resultados potenciales no observadas para cada unidad $i$.  Esta puede ser, por ejemplo, una diferencia o un radio de salidades potenciales no observadas.
