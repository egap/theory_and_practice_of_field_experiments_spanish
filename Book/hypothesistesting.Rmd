...
A continuación presentamos las diapositivas con el contenido principal que cubrimos en nuestra clase sobre pruebas de hipótesis.  Usted puede usar directamente los archivos originales de las diapositivas o también puede copiarlos y editarlos localmente.
 ...
 - [Archivo de R Markdown](https://egap.github.io/learningdays-resources/Slides_esp/hypothesistesting-slides.Rmd)

 - [Versión en PDF](https://egap.github.io/learningdays-resources/Slides_esp/hypothesistesting-slides.pdf)

 - [Versión de HTML](https://egap.github.io/learningdays-resources/Slides_esp/hypothesistesting-slides.html)
...
### Guías de métodos de EGAP
  ...
  - Guía de métodos de EGAP [10 Cosas que debe saber sobre las pruebas de hipótesis](https://egap.org/es/resource/10-cosas-que-debe-saber-sobre-las-pruebas-de-hipotesis/)

  - Guía de métodos de EGAP [10 Cosas que debe saber sobre comparaciones multiples](https://egap.org/resource/10-things-to-know-about-multiple-comparisons/) (en inglés)
